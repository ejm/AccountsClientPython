...
names_raw = urlopen('http://pastebin.com/raw.php?i=MQeZjhrp').read().split() # Random Fist of Names found on Pastebin
names = [] # Refined List of Names

for i in range(200): # we want 200 names in this example
  names.append(names_raw[i].decode("utf-8")) #Notice we decode bytes like objects to python strings
